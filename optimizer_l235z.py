...
def build_and_solve(ci, P, freeze_units, rho=0.06, sep_trim=False, prune_B=None,
    ...
    _t1 = time.perf_counter()
    _L235T["sep_reduce+emit"] += _t1 - _t0
    _L235N["sep_reduce+emit"] += 1
    _t0 = _t1
    ...
    _t1 = time.perf_counter()
    _L235T["bnd+env+tangent"] += _t1 - _t0
    _L235N["bnd+env+tangent"] += 1
    _t0 = _t1
