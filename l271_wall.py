...
ALL = {
    ...
    # L271/L273 arms. l271sng = at the first successful frame, re-pack the SAME
    # frame in the density order (no guide) and keep the better by layout_score.
    # A successful retry consumes one of max_trials, so it REPLACES a frame trial
    # rather than adding one -- which is why its pack bill reads 1.000x. That has
    # to be confirmed on the stopwatch: L267 measured 1.063x packs vs 1.2417x wall.
    "l271":    {"ICCAD_L271": "1"},
    "l271s":   {"ICCAD_L271": "5"},
...
def main():
    ...
    ap.add_argument("--out", default="l271_wall.pkl")
