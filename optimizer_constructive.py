...
# Profiles validated by portfolio_ceiling.py (oracle 1.6057, proxy RH=1.0 1.6060).
# Aspect variants are the key diversity axis (low vBd on violation-heavy cases).
