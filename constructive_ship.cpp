...
static void solve() {
    ...
    // L269: the frame list becomes mutable so the loop can propose its OWN next
...
int main() {
    ...
    if (const char* e=getenv("ICCAD_L269")){ int v=atoi(e); if (v>=0&&v<=2) L269=v; }   // L274: accept 0 = kill switch
